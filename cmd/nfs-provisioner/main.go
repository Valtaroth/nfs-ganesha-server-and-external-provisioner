...
import (
	...
	"github.com/Valtaroth/nfs-ganesha-server-and-external-provisioner/pkg/server"
	vol "github.com/Valtaroth/nfs-ganesha-server-and-external-provisioner/pkg/volume"
...
var (
	...
	exportDir      = flag.String("export-dir", "/export", "The directory to create volumes in. Default /export.")
)
